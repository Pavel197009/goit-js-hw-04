...
function isEnoughCapacity(products, containerSize) {
    let values = Object.values(products);   // создание массива знгачений свойств объекта
    let sum = 0;
    for (let value of values) {
        sum += value;                       // сложение элементов массива
    }
    return sum <= containerSize;            // возврат условия сравнения суммы и емкости контейнера
}   
